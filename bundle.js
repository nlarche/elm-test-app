...
var _user$project$Main$listHeader = function (text$) {
	return A2(
...
var _user$project$Main$add = function (model) {
	var player = A3(
		...
		model.name,
		0);
	var newPlayes = A2(_elm_lang$core$List_ops['::'], player, model.players);
	return _elm_lang$core$Native_Utils.update(
		model,
		{players: newPlayes, name: ''});
};
		...
		var newPlayers = A2(
			...
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.id, scorer.id) ? _elm_lang$core$Native_Utils.update(
					player,
					{points: scorer.points + points}) : player;
			},
			model.players);
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Main$playSection = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$listHeader('plays'),
...
var _user$project$Main$playerForm = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onSubmit(_user$project$Main$Save)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(_user$project$Main$Cancel)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Main$playerSection = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$listHeader('Name'),
				_user$project$Main$playerList(model),
				_user$project$Main$pointTotal(model)
			]));
};
